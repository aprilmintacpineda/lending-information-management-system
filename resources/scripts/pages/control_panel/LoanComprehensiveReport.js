...
// actions
import * as reportsActions from '../../actions/control_panel/reports';
// helpers
...
class LoanComprehensiveReport extends Component {
  ...
  render() {
    ...
    return (
      <WithSidebar>
        <div className="loan-comprehensive-report-container">
              ...
              <div className="body">
                ...
                <section>
                  ...
                  {!this.props.loan.data.penalties.length?
                      <p>No penalties.</p>
                  : this.props.loan.data.penalties.map((penalty, penalty_payment) => (
                    <section key={penalty_payment}>
                      <table className="short-table">
                        <tbody>
                          <tr>
